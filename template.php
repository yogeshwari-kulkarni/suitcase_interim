...
function suitcase_interim_preprocess_region(&$vars) {
  if($vars['region'] == 'content' && arg(0) == 'node' && is_numeric(arg(1)) && arg(2) !== 'edit') {
    ...
    $vars['site_name_level_2'] = variable_get('suitcase_config_level_2');
    ...
    $vars['site_name_level_3'] = variable_get('suitcase_config_level_3');
    ...
    if (!$vars['site_wordmark'] || ($vars['suitcase_config_header_type'] != '4' && $vars['suitcase_config_header_type'] != '5')) {
