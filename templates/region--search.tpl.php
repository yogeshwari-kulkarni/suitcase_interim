<div<?php print $attributes; ?>>
  <div<?php print $content_attributes; ?>>
    <div class="clearfix">
      <?php $site_name_level_2_class = ($suitcase_config_header_type < 3) ? ' has-site-name-level-2' : ''; ?>
      <?php $site_name_level_3_class = ($suitcase_config_header_type == 1 || $suitcase_config_header_type == 3 || $suitcase_config_header_type == 4) ? ' has-site-name-level-3' : ''; ?>
